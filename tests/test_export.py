...
class TestDatasetExport(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_dataset_release_export(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(dt1_datasets[0]["dataset_id"], ref1.id)
            ...
            self.assertEqual(dt1_datasets[1]["dataset_id"], ref2.id)
            ...
            self.assertEqual(dt2_datasets[0]["dataset_id"], ref3.id)
            ...
            self.assertEqual(provenance_datasets[0]["dataset_id"], prov1.id)
            ...
            self.assertEqual(provenance_datasets[1]["dataset_id"], prov2.id)
            ...
            self.assertEqual(dt1_associations[0]["dataset_id"], ref2.id)
            ...
            self.assertEqual(dt4_associations[0]["dataset_id"], ref5.id)
            ...
            self.assertEqual(dt4_associations[1]["dataset_id"], ref6.id)
